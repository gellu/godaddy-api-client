...
/**
 * PrivacyPurchase Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     GoDaddyDomainsClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PrivacyPurchase implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PrivacyPurchase';
    ...
    /**
     * Sets consent
     * @param \GoDaddyDomainsClient\Model\Consent $consent Specify agreement `DNPA`.  Required agreements can be retrieved via the GET ./domains/agreements endpoint
     * @return $this
     */
