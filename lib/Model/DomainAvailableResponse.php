...
/**
 * DomainAvailableResponse Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     GoDaddyDomainsClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DomainAvailableResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'DomainAvailableResponse';
    ...
    /**
     * Sets available
     * @param bool $available Whether or not the domain name is available
     * @return $this
     */
    ...
    /**
     * Sets price
     * @param int $price Price of the domain excluding taxes or fees
     * @return $this
     */
    ...
    /**
     * Sets currency
     * @param string $currency Currency in which the `price` is listed
     * @return $this
     */
    ...
    /**
     * Sets period
     * @param int $period Number of years included in the price
     * @return $this
     */
