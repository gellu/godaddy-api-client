...
/**
 * DNSRecordCreateType Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     GoDaddyDomainsClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DNSRecordCreateType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'DNSRecordCreateType';
    ...
    public function setPort($port)
    {
        ...
        if ($port > 65535.0) {
            throw new \InvalidArgumentException('invalid value for $port when calling DNSRecordCreateType., must be smaller than or equal to 65535.0.');
        }
        if ($port < 1.0) {
            throw new \InvalidArgumentException('invalid value for $port when calling DNSRecordCreateType., must be bigger than or equal to 1.0.');
        }
