...
class Configuration
{
     ...
     *
     * @var \GoDaddyDomainsClient\ApiClient
     */
     ...
     * @var string
     */
    protected $host = 'https://api.godaddy.com/';
    ...
    {
        $report  = 'PHP SDK (GoDaddyDomainsClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 2.4.8' . PHP_EOL;
